 ...
 * @author Mehmet turan
 */
public class Aracsahipleri extends Dosyaislemleri implements ActionListener{
    ...
    public Aracsahipleri(){
       ...
       panel2.add(btn2);
        ...
        String[] columnNames = { "Araba Id", "Musteri Id", "Ad Soyad","Ucret","Tarih","Donus T."};
		table1 = new JTable();

...
public  AracKiralama() {
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==btn1){
            ...
            dosyaOlustur();
            aracsahibidosyaOku();
            aracsahibicountlines();
            aracsahibiveriEkle((String) combobox.getSelectedItem(), tlabel2.getText(),tlabel3.getText(),tlabel4.getText(), (String) date.getSelectedItem()+" "+month.getSelectedItem()+" "+year.getSelectedItem(), (String) date1.getSelectedItem()+" "+month1.getSelectedItem()+" "+year1.getSelectedItem(),0);
        }
